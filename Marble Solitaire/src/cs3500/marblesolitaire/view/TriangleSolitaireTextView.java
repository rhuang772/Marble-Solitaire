...
/**
 * The {@code MarbleSolitaireView} represents the methods used for a
 * TriangleSolitaireTextView object.
 */
public class TriangleSolitaireTextView implements MarbleSolitaireView {
  ...
  /**
   * Constructs a {@code MarbleSolitaireView} that takes in a TriangleSolitaireModelState.
   * It inherits the methods from the interface that the object represents.
   ...
   */
  public TriangleSolitaireTextView(MarbleSolitaireModelState msModelState)
   ...
   */
  public TriangleSolitaireTextView(MarbleSolitaireModelState msModelState, Appendable ap)
          throws IllegalArgumentException {
  ...
  public String toString() {
    ...
    for (int row = 0; row < this.msModelState.getBoardSize(); row++) {
      gameRepresentation = gameRepresentation.append(addSpaces(row));
  ...
  private String addSpaces(int row) {
    StringBuilder spaces = new StringBuilder("");
    int numSpacesToAdd = this.msModelState.getBoardSize() - row - 1;
